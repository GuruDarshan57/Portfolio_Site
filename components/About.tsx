  ...
  return (
    <div id="about" className="flex flex-col gap-4 w-full py-10">
      ...
      <div className="text-justify tracking-wide">
        ...
        odit delectus magnam suscipit eaque quisquam animi unde dolor
        voluptatem. Nemo, dolores. Aperiam optio asperiores nihil. Animi at quos
        qui. Perferendis consequuntur doloribus nam atque id, nemo maiores sed
        temporibus quae, labore at quibusdam minus esse consequatur quos odio
        officia.
      </div>
