    ...
    <div id="home" className="flex gap-10 w-full p-2 py-4 pt-20">
      <div className="flex-1 flex flex-col gap-2">
        ...
        <div className="text-justify text-sm">
          ...
          obcaecati quam ducimus! Magni, dolor fuga, mollitia voluptatibus
          explicabo unde est perspiciatis sint iure similique dignissimos
          facilis accusantium veniam. Natus, molestiae?
        </div>
      </div>
      <div className="flex ">
        <Image
